...
{
    class CreationJeuManuelle2ViewModel : Caliburn.Micro.Screen, INotifyPropertyChanged
    {
        ...
        {            
            GamePreview gamePreview = new GamePreview(Potrace.Potrace.potrace(""), (Mode)mode);
